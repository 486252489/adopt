    ...
    function build_admins_table(result){
        ...
        $.each(admins,function(index,admin){
            ...
            if( index%2 != 0){
                ...
                addClass("img-responsive").attr("src","/static/images/animal/"+admin.pic));
                adminNameTd=$("<div></div>").addClass("team-grid-left non").append($("<h4></h4>")).append(admin.title);
                remarkTd=$("<p></p>").append(admin.author);
                adminNameTd.append(remarkTd);
            }else{
                pic=$("<div></div>").addClass("team-grid-right").append($("<img/>").
                addClass("img-responsive").attr("src","/static/images/animal/"+admin.pic));
                adminNameTd=$("<div></div>").addClass("team-grid-left").append($("<h4></h4>")).append(admin.title);
                remarkTd=$("<p></p>").append(admin.author);
                adminNameTd.append(remarkTd);
            }
